"""LLM 连接池：多 Provider，DeepSeek 优先，其余随机"""
import json
import os
import random
import time
...
class LLMPool:
    ...
    def _get_model(self, provider: str) -> str:
        return PROVIDERS.get(provider, {}).get("model", "gpt-3.5-turbo")
...
{{"summary": "一句话解释这个项目是做什么的", "tech_stack": "技术栈/语言", "why_hot": "为什么最近火了"}}
"""
